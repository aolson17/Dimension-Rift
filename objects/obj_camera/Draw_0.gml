...
if obj_player.dimensions_unlocked = 3{
	...
	switch(obj_dimensions.target_dimension){
		case 1:	draw_text(target_text_x,gui_y+10,"- Target")
			break
		case 2:	draw_text(target_text_x,gui_y+30,"- Target")
			break
		case 3:	draw_text(target_text_x,gui_y+50,"- Target")
			break
	}
	switch(obj_dimensions.current_dimension){
		case 1:	draw_text(target_text_x,gui_y+10,"- Current")
			break
		case 2:	draw_text(target_text_x,gui_y+30,"- Current")
			break
		case 3:	draw_text(target_text_x,gui_y+50,"- Current")
			break
	}
}
