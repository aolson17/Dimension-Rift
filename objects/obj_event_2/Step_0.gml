...
if !global.in_dialogue && global.dialogue_ready{
	if point_distance(x,y,obj_player.x,obj_player.y) < obj_dialogue.range{
		if dialogue_stage = 0{ // If this is the first time talking
			...
			scr_dialogue(spr_portrait_speaker,global.font,"Climbing these platforms may be a bit of a challenge for you.")
			scr_dialogue(spr_portrait_speaker,global.font,"Remember that you can left-click to peer into the other dimension!")
		}
	}
}
